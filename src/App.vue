...
export default {
  ...
  methods: {
    ...
    jiemi(){
        ...
        let b = axios.post('https://58004b9d60dc41389986626267835cb4.apig.ap-southeast-1.huaweicloudapis.com/aes?responseType=json&cryptType=de&cryptdata='+encodeURIComponent(this.data1)+'', {
          })
          .then(function (response) {
            return response.data.key
          })
